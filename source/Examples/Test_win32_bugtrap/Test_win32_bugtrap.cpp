// Test_win32_bugtrap.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "Test_win32_bugtrap.h"
#include <string>
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_TEST_WIN32_BUGTRAP, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TEST_WIN32_BUGTRAP));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TEST_WIN32_BUGTRAP));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_TEST_WIN32_BUGTRAP);
